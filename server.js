...
mongo.connect('mongodb://test:54321@cluster0-shard-00-00.ioorb.mongodb.net:27017,cluster0-shard-00-01.ioorb.mongodb.net:27017,cluster0-shard-00-02.ioorb.mongodb.net:27017/LuisDB?ssl=true&replicaSet=atlas-l8jjoh-shard-0&authSource=admin&retryWrites=true&w=majority', function(err, db){
    if(err){
        throw err;
    }
